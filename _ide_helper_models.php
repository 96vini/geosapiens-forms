...
/**
 * App\Containers\AppSection\Fill\Models\Fill
 *
 * @property int $id
 * @property int $form_id
 * @property mixed $content
 * @method static \Illuminate\Database\Eloquent\Builder|Fill newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|Fill newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|Fill query()
 * @method static \Illuminate\Database\Eloquent\Builder|Fill whereContent($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Fill whereFormId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Fill whereId($value)
 */
	class Fill extends \Eloquent {}
}

namespace App\Containers\AppSection\Form\Models{
/**
 * App\Containers\AppSection\Form\Models\Form
 *
 * @property int $id
 * @property string $name
